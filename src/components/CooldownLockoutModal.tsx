...
import { ShieldAlert, Sun, Coffee, Eye, Wind, LogOut, LogIn, Settings, RefreshCw, User } from 'lucide-react';
      ...
      >
        ...
        <div className="w-full flex items-center justify-between px-3.5 py-2 rounded-xl bg-[#0c0d10] border border-[#22242a] mb-4 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            {isGuest && onOpenSettings && (
              <button
                onClick={onOpenSettings}
                className="px-2.5 py-1 rounded-lg bg-[#00ff95]/15 hover:bg-[#00ff95]/25 border border-[#00ff95]/40 text-[#00ff95] text-[11px] font-bold transition cursor-pointer flex items-center gap-1.5"
        ...
        <div className="flex flex-wrap items-center justify-center gap-2.5 w-full">
          ...
          {isGuest && onOpenSettings && (
            <button
              onClick={onOpenSettings}
              className="px-4 py-2 rounded-lg bg-[#00ff95]/15 hover:bg-[#00ff95]/25 border border-[#00ff95]/40 text-[#00ff95] text-xs font-bold transition cursor-pointer flex items-center gap-1.5"
              title="Log in or register account"
            >
